...
<body>
	...
	<div class="top">
		...
		<div class="top_2" style="width: auto;">
			<ul id="ul_2">
			<c:if test="${user==null}">
				<li><a href="${pageContext.request.contextPath}/regist.action">注册</a>
				</li>
				<li><a href="${pageContext.request.contextPath}/landing.action">登录</a>
				</li>
				</c:if>
				<c:if test="${user!=null}">
				<b>欢迎&nbsp;${user.uName}！</b>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/distroy.action">注销</a>
				</c:if>
