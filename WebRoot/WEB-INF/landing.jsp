		...
		<script type="text/javascript">
			$(window).load(function() {
				...
				$('#imgcheck').click(function() {
					$(this).attr('src', "${pageContext.request.contextPath}/check.action?time=" + new Date().getTime());
				});
				...
				function checkLandingpasswordRightOrWrong(password, userName) {
					var url = "${pageContext.request.contextPath}/checkLandingPassword.action";
					$.post(url, {
				...
				function checkLandingUserValitedAndNot(userName) {
					var url = "${pageContext.request.contextPath}/checkLandingUserName.action";
					$.post(url, {
	...
	<body>
		<div class="sum">
			...
			<div class="content">
				...
				<form method="post" action="${pageContext.request.contextPath}/finalCheckLanding.action">
					...
					<div class="tab1" id="tab1">
						...
						<div class="end">
							...
							<div class="user_3"><img id="imgcheck" src="${pageContext.request.contextPath}/check.action" /></div>
						</div>
					</div>
					<!------------------------菜单end----------------------------->
					<!---------------------------------账户登录------------------------>
					<div class="public"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<a href="${pageContext.request.contextPath}/regist.action"><input type="button" value="马上注册>>" /> </a>
