	...
	<body>
		<div class="sum">
			...
			<div class="content">
				...
				<!--------------------------table开始---------------------------------->
				<!-----form---------------------------->
				<form method="post" action="${pageContext.request.contextPath}/finalCheck.action">
				...
				<!--------------------------table结束---------------------------------->
				<div class="landYzm">
					<img id="imgcheck" src="${pageContext.request.contextPath}/check.action" style="margin-left:130px" />
